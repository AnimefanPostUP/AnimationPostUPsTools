...
def sideloadtester():  return 	'file: functionimporttest.py    line: 0'
def combine_into_transformation_matrix(translation, scale, rotation):  return 	'file: 01_module_ma_matrices.py    line: 3'
def get_vertex_Center(vertex_positions):  return 	'file: 01_module_ma_matrices.py    line: 21'
def calculate_average_distance(vertex_positions, center):  return 	'file: 01_module_ma_matrices.py    line: 30'
def calculate_rotation_matrix(old_positions, new_positions, old_center, new_center):  return 	'file: 01_module_ma_matrices.py    line: 36'
def calculateCenterOfPoints(points, axis=0):  return 	'file: 01_module_ma_matrices.py    line: 54'
def calculate_vertex_transformation(src_points, dst_points ):  return 	'file: 01_module_ma_matrices.py    line: 58'
def multiply_matrix(matrix, positions):  return 	'file: 01_module_ma_matrices.py    line: 116'
def debug_write_vertex_coordinated(self, context):  return 	'file: 02_operators_debug.py    line: 5'
def debug_setupBone(self, context):  return 	'file: 02_operators_debug.py    line: 18'
def debug_print_vertex_withBoneAnimation(self, context):  return 	'file: 02_operators_debug.py    line: 40'
def debug_print_applyAnimation(self, context):  return 	'file: 02_operators_debug.py    line: 60'
def get_current_Vertcount():  return 	'file: 20_module_bl_current_obj_getters.py    line: 0'
def find_most_facing_axis(vector):  return 	'file: 21_module_op_pivot.py    line: 0'
def setPivot(self, context):  return 	'file: 21_module_op_pivot.py    line: 17'
def setSelectionforAllObjects(selected_Objects, state):  return 	'file: 22_module_bl_selector.py    line: 0'
def linear_to_sRGB(linear_value):  return 	'file: 30_module_bl_image.py    line: 0'
def math_UVPosition_By_Tile(xt, yt, tile_count_x, tile_count_y):  return 	'file: 30_module_bl_image.py    line: 7'
def math_PixelIndex_By_TileNumber(xt, yt, width, height, tile_count_x, tile_count_y, uv_offset_x=0, uv_offset_y=0):  return 	'file: 30_module_bl_image.py    line: 26'
def math_getTileFromUVXY(tilecountx, tilecounty, x,y):      return 	'file: 30_module_bl_image.py    line: 48'
def math_getTileFromUV(tilecountx, tilecounty, uv):  return 	'file: 30_module_bl_image.py    line: 64'
def img_readPixel_By_Index(img, index):  return 	'file: 30_module_bl_image.py    line: 80'
def readImagePixel(image, x, y):  return 	'file: 30_module_bl_image.py    line: 90'
def img_getImagePixelIndex(xt, yt, imagewidth):  return 	'file: 30_module_bl_image.py    line: 107'
def img_getTilesetPixelIndex(xt, yt, tilesizex):  return 	'file: 30_module_bl_image.py    line: 118'
def math_getIndexByTile(xt, yt, tile_count_x):  return 	'file: 30_module_bl_image.py    line: 129'
def cleanupSharpsAndSplits(self, context):  return 	'file: 40_module_bl_normals.py    line: 0'
def smoothObjects(self, context):  return 	'file: 40_module_bl_normals.py    line: 17'
def smoothReversedSelection(self, context):  return 	'file: 40_module_bl_normals.py    line: 30'
def mergeNormals(self, context):  return 	'file: 40_module_bl_normals.py    line: 36'
def splitNormals(self, context):  return 	'file: 40_module_bl_normals.py    line: 43'
def rotate90DegL(self, context):  return 	'file: 50_module_bl_rotationtool.py    line: 0'
def rotate90DegR(self, context):  return 	'file: 50_module_bl_rotationtool.py    line: 23'
def clipRotation(self, context):    return 	'file: 50_module_bl_rotationtool.py    line: 47'
def create_vertex_group(obj, group_name):  return 	'file: 70_module_bl_vertexgroups.py    line: 1'
def remove_vertex_groups(obj):  return 	'file: 70_module_bl_vertexgroups.py    line: 7'
def remove_vertex_groups_by_name(obj, group_name):  return 	'file: 70_module_bl_vertexgroups.py    line: 13'
def add_vertex_group_to_object(obj, group_name):  return 	'file: 70_module_bl_vertexgroups.py    line: 19'
def createVertexgroupIfNotExists(obj, group_name):  return 	'file: 70_module_bl_vertexgroups.py    line: 30'
def createIncrementedVertexgroupIfNotExists(obj, group_name):  return 	'file: 70_module_bl_vertexgroups.py    line: 34'
def applyVertexgroupToMesh(obj, group_name, vertex_indices):  return 	'file: 70_module_bl_vertexgroups.py    line: 43'
def clean_other_groups(obj, groupname, changed_vertices):  return 	'file: 70_module_bl_vertexgroups.py    line: 48'
def selectByGroup(self, ctx):  return 	'file: 70_module_bl_vertexgroups.py    line: 57'
def select_vertices_in_group(group):  return 	'file: 70_module_bl_vertexgroups.py    line: 101'
def get_vertex_groups_from_selected():  return 	'file: 70_module_bl_vertexgroups.py    line: 139'
def get_common_vertex_groups_from_selected():  return 	'file: 70_module_bl_vertexgroups.py    line: 159'
def getAllVertexIndices(obj):  return 	'file: 71_module_bl_vertexmanipulation.py    line: 1'
def getPositionFromIndices(obj, vertex_indices):  return 	'file: 71_module_bl_vertexmanipulation.py    line: 4'
def set_vertex_positions(obj, vertex_indices, positions):  return 	'file: 71_module_bl_vertexmanipulation.py    line: 7'
def set_vertex_positions_bmesh(obj, vertex_indices, positions):  return 	'file: 71_module_bl_vertexmanipulation.py    line: 11'
def set_vertex_positions_4dsafe(obj, vertex_indices, positions):  return 	'file: 71_module_bl_vertexmanipulation.py    line: 33'
def createAnimation(obj, bone, transformation_matrix, last_frame):  return 	'file: 80_module_bl_animation.py    line: 1'
def checkIfBoneExists(armature, bone_name):  return 	'file: 81_module_bl_armatures.py    line: 4'
def getBoneifExists(armature, bone_name):  return 	'file: 81_module_bl_armatures.py    line: 10'
def removeArmatureAndVertexgroups(obj, armature):  return 	'file: 81_module_bl_armatures.py    line: 30'
def removeArmatureifExists(context, mesh):  return 	'file: 81_module_bl_armatures.py    line: 43'
def apply_transformations(obj, armature, vertex_indices, positions):  return 	'file: 81_module_bl_armatures.py    line: 52'
def createArmatureifNotExists(context, mesh):  return 	'file: 81_module_bl_armatures.py    line: 95'
def createBoneifNotExists(armature, bone_name, position):  return 	'file: 81_module_bl_armatures.py    line: 131'
def getPositionByAnimation_Bonespace(new_positions, obj, armature, groupbone):  return 	'file: 81_module_bl_armatures.py    line: 157'
def getMatrixOfAnimation_PoseBonespace(obj, armature, groupbone):  return 	'file: 81_module_bl_armatures.py    line: 199'
def revertPositionByAnimation(positions, obj, armature, groupbone):  return 	'file: 81_module_bl_armatures.py    line: 221'
def convert_to_armature_space(armature, position, obj):  return 	'file: 81_module_bl_armatures.py    line: 250'
def getPositionByAnimation(new_positions, obj, armature, groupbone):  return 	'file: 81_module_bl_armatures.py    line: 265'
def apply_transformation_to_bone(obj, bone, transformation_matrix):  return 	'file: 81_module_bl_armatures.py    line: 303'
def get_keydata_index_by_object_name(context, object_name):  return 	'file: 90_module_pg_keydata_management.py    line: 1'
def remove_keydata(keydata, context):  return 	'file: 90_module_pg_keydata_management.py    line: 9'
def create_for_vertexgroupdata(keydata, group_name):  return 	'file: 90_module_pg_keydata_management.py    line: 24'
def create_vertexpositiondata(vertex_group_data, vertex_id, vertex_position):  return 	'file: 90_module_pg_keydata_management.py    line: 37'
def get_vertexgroupdata_by_name(keydata, group_name):  return 	'file: 90_module_pg_keydata_management.py    line: 46'
def get_vertexpositiondata_by_id(vertex_group_data, vertex_id):  return 	'file: 90_module_pg_keydata_management.py    line: 53'
